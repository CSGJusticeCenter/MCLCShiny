...
#tables <- readRDS("C:/Users/meichlersmith/The Council of State Governments/JC Research - Documents/50 State Revocations Project/MCLC Shiny App/data_new/analysis/NCRP_N_RRI_tables.RDS")
