...
# warning: this takes a long time because it hits the api for each state for each year
# (could set up an ipums download alternatively, but i don't love the ipums interface)
pums <- map(2015:2019, get_pums_race_eth)
